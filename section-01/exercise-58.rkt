...
(define TAX_RATE_1 0.05)
(define TAX_RATE_CUTOFF_1 1000)
(define TAX_RATE_2 0.08)
(define TAX_RATE_CUTOFF_2 10000)
...
;; (define (sales-tax p)
;;   (cond
;;     [(and (>= p 0) (< p TAX_RATE_CUTOFF_1)) ...]
;;     [(and (>= p TAX_RATE_CUTOFF_1) (< p TAX_RATE_CUTOFF_2)) ...]
;;     [(>= p TAX_RATE_CUTOFF_2) ...]
;;    )
;;  )
;; 5. CODE:
(define (sales-tax p)
  (cond
    [(and (>= p 0) (< p TAX_RATE_CUTOFF_1)) 0]
    [(and (>= p TAX_RATE_CUTOFF_1) (< p TAX_RATE_CUTOFF_2)) (* p TAX_RATE_1)]
    [(>= p TAX_RATE_CUTOFF_2) (* p TAX_RATE_2)]
    )
  )
