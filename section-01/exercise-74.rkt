...
;; 2a. FUNCTION SIGNATURE: Posn Number Number MouseEvt -> Posn 
;; 2b. PURPOSE STATEMENT: For mouse clicks, (make-posn x y); otherwise p.
;; 2c. HEADER:
;; (define (reset-dot p x y me) p)
;; 3a. FUNCTIONAL EXAMPLES:
;; Given: 10.20 29 31 "button-down", Expect: 29.31
;; Given: 10.20 29 31 "button-up", Expect: 10.20
;; 3b. TESTS:
